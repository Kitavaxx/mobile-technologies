package com.example.calculator.pages.Advanced
...
import com.example.calculator.pages.Basic.BasicCalculatorLandscapeUI
import com.example.calculator.pages.Basic.BasicCalculatorUI
...
fun AdvancedCalculator() {
    ...
    if(!isLandscape) AdvancedCalculatorUI()
    else AdvancedCalculatorLandscapeUI()
}
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun AdvancedCalculatorLandscapeUI() {
    val viewModel : MyViewModel = viewModel()
    val input = viewModel.input.collectAsState()
    val currentContext = LocalContext.current
    val scrollState = rememberScrollState()
